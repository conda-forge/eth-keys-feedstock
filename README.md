...
Once the `conda-forge` channel has been enabled, `eth-keys` can be installed with:

```
conda install eth-keys
```

It is possible to list all of the versions of `eth-keys` available on your platform with:
